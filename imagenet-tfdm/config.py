...
log_file = 'result/log/VGG16.txt'
load_weight_file = None
# save_weight_file = 'result/weight/ResNet_50_v2.h5'
save_weight_file = 'result/weight/VGG16.h5'

# Dataset config
train_list_path = 'data/train_label.txt'
test_list_path = 'data/validation_label.txt'
train_data_path = '/home/inspur/hengyuepan/databases/train'
test_data_path = '/home/inspur/hengyuepan/databases/val_nofolder'
